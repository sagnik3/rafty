import collections
from rafty.client.abstractClient import AbstractClient
from rafty.client.refresh_policies import RefreshPolicyAlways


class DistributedDict(collections.UserDict, AbstractClient):
    """Client for rafty instances with dictionary based state machines."""

    def __init__(
        self, addr, port, append_retry_attempts=3, refresh_policy=RefreshPolicyAlways()
    ):
        super().__init__()
